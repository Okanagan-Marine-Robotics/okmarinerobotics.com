    ...
    <section class="section" style="padding-top: 50px; background: var(--bg-page);">
      <div class="container">
        <div class="section-header">
          ...
          <h1 class="section-title">The Hydrofoil Project</h1>
        ...
        <div class="card" style="padding: 0; overflow: hidden; margin-bottom: 50px;">
          ...
          <div style="padding: 36px;">
            <h2 style="font-size: 1.8rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 12px; text-transform: uppercase;">
              Next Horizon: Hydrodynamic Flight
            </h2>
            <p style="color: var(--text-body); font-size: 1.15rem; line-height: 1.8; margin-bottom: 24px;">
        ...
        <div class="card-grid">
          <div class="card">
            ...
            <h3 style="font-size: 1.5rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 10px; text-transform: uppercase;">Foil Aerofoil & Lift Profile</h3>
          ...
          <div class="card">
            ...
            <h3 style="font-size: 1.5rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 10px; text-transform: uppercase;">Carbon-Fiber Construction</h3>
            <p style="color: var(--text-body); line-height: 1.6;">
          ...
          <div class="card">
            ...
            <h3 style="font-size: 1.5rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 10px; text-transform: uppercase;">Ride Height & Pitch Autopilot</h3>
            <p style="color: var(--text-body); line-height: 1.6;">
