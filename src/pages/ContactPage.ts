          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <div class="card">
              <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 10px;">
                <div style="width: 44px; height: 44px; border-radius: 50%; background: var(--ocean-tint); display: flex; align-items: center; justify-content: center; color: var(--ocean-blue);">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                </div>
                <div>
                  <div style="font-size: 0.85rem; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Direct Email</div>
                  <a href="mailto:${siteConfig.email}" style="font-size: 1.15rem; font-weight: 700; color: var(--navy-deep);">
                    ${siteConfig.email}
                  </a>
                </div>
              </div>
            ...
            <div class="card">
              <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 10px;">
                ...
                <div>
                  <div style="font-size: 0.85rem; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Campus Location</div>
                  <div style="font-size: 1.15rem; font-weight: 700; color: var(--navy-deep);">
            ...
            <div class="card">
              <h3 style="font-size: 1.25rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 10px; text-transform: uppercase;">Connect on Social Media</h3>
              <p style="color: var(--text-body); font-size: 0.92rem; margin-bottom: 16px;">
                Follow our testing logs, competition travel videos, and prototype builds in real-time.
              </p>
              <div class="social-links">
                <a href="${siteConfig.socials.instagram}" target="_blank" rel="noopener" class="social-btn" style="background: var(--ocean-tint); color: var(--ocean-blue); border-color: #D0E4F5;" aria-label="Instagram">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                </a>
                <a href="${siteConfig.socials.linkedin}" target="_blank" rel="noopener" class="social-btn" style="background: var(--ocean-tint); color: var(--ocean-blue); border-color: #D0E4F5;" aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                </a>
                <a href="${siteConfig.socials.github}" target="_blank" rel="noopener" class="social-btn" style="background: var(--ocean-tint); color: var(--ocean-blue); border-color: #D0E4F5;" aria-label="GitHub">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
                </a>
                <a href="${siteConfig.socials.youtube}" target="_blank" rel="noopener" class="social-btn" style="background: var(--ocean-tint); color: var(--ocean-blue); border-color: #D0E4F5;" aria-label="YouTube">
