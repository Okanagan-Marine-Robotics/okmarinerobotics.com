    ...
    <section class="section" style="padding-top: 50px; background: var(--bg-page);">
      <div class="container">
        <div class="section-header">
          ...
          <h1 class="section-title">AUV Electrical Engineering</h1>
        ...
        <div class="card" style="padding: 0; overflow: hidden; margin-bottom: 50px;">
          ...
          <div style="padding: 24px 32px;">
            <h3 style="font-size: 1.4rem; font-weight: 800; color: var(--navy-deep); margin-bottom: 8px; text-transform: uppercase;">AUV Electrical Subteam</h3>
